...
const PickDateCard = React.forwardRef<HTMLDivElement, PickCardType>(
  ...
  ({ day, dayNum, className, ...props }, ref) => {
    return (
      <Card
        className={cn(
          'w-[9.5rem] select-none border-brand bg-paleBlue text-brand hover:cursor-pointer data-[state=on]:scale-110 data-[state=on]:border-8 data-[state=on]:border-primary data-[state=off]:bg-red-500 data-[state=on]:bg-white data-[state=unselected]:bg-green-500 data-[state=on]:shadow-2xl',
          className
        )}
        ref={ref}
        {...props}
      ...
      <div className="container space-y-20 bg-paleBlue pt-16">
        ...
        <div className="flex-row justify-center gap-x-4 space-y-11">
          ...
          <div className="flex">
            ...
            >
              <ExtendedToggleGroupItem value="fri-22" asChild>
                <PickDateCard dayNum={22} day="Fri" />
              </ExtendedToggleGroupItem>

              <ExtendedToggleGroupItem value="sat-23" asChild>
                <PickDateCard dayNum={23} day="Sat" />
              </ExtendedToggleGroupItem>

              <ExtendedToggleGroupItem value="sun-24" asChild>
                <PickDateCard dayNum={24} day="Sun" />
              </ExtendedToggleGroupItem>

              <ExtendedToggleGroupItem value="mon-25" asChild>
                <PickDateCard dayNum={25} day="Mon" />
              </ExtendedToggleGroupItem>
              {/*
              <ExtendedToggleGroupItem value="tue-26" asChild>
                <PickDateCard dayNum={26} day="Tue" />
              </ExtendedToggleGroupItem>

              <ExtendedToggleGroupItem value="wed-27" asChild>
                <PickDateCard dayNum={27} day="Wed" />
              </ExtendedToggleGroupItem>

              <ExtendedToggleGroupItem value="thu-28" asChild>
